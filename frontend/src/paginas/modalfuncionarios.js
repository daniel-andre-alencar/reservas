...
function Funcionariosmodal() {
  ...
  const { id } = useParams();
  const [func, setFormData] = useState([]);
    ...
    <Container  fluid>
      ...
      <Col>
        ...
        <Form.Group as={Row} className="me-2" controlId="formBasicEmail">
          ...
          <Col sm={6}>
          <Form.Control type="text" placeholder="" name='cpf' value={func.cpf}/>
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="me-2" controlId="formBasicPassword">
          <Form.Label>NOME:</Form.Label>
          <Col sm={6}>
          <Form.Control type="text" placeholder="" name='nome' value={func.nome}/>
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="me-2" controlId="formBasicPassword">
          <Form.Label>CEP:</Form.Label>
          <Col sm={6}>
          <Form.Control type="text" placeholder="" name='cep' value={func.cep}/>
          </Col>
        </Form.Group>      
